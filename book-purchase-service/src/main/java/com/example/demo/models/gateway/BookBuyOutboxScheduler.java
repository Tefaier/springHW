...
@Service
@ConditionalOnProperty(value = "book-purchase-result.mode", havingValue = "outbox")
public class BookBuyOutboxScheduler {
  private static final Logger LOGGER = LoggerFactory.getLogger(BookBuyOutboxScheduler.class);
  ...
  @Autowired
  public BookBuyOutboxScheduler(KafkaTemplate<String, String> kafkaTemplate,
                                @Value("${topic-book-purchase-result}") String topic,
